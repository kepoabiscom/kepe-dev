<nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background: rgba(0, 0, 0, 0) linear-gradient(to bottom, #4c0000 0%, #870000 10%, #870000 100%) repeat scroll 0 0;">
		<div id="aei-navbar-top-img" style="background-color: #333333">
             <div class="container">
                 <div class="row">
                    <div class="col-md-6">
                            <!--<img class="img-responsive" alt="Ikatan Arsitek Indonesia" src="assets/templates/thirteen/img/weblogohor-sm-2.png">-->
      ...
      <div class="container" >
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="-aei-navbar-nav" class="nav navbar-nav">
                <li class="active">
					<a title="Beranda" href="index.php">
						Beranda
					</a> 
				</li>
				<li class="">
					<a title="Berita" href="berita.php">
						Berita
					</a>  
				</li>
				<li class="">
					<a title="Artikel" href="artikel.php">
						Artikel
					</a>
				</li>
				...
				<li class=" ultimateparent">
					<a title="Kontak" href="contact.php">
						Kontak
					</a>
				</li>
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
					 ...
					 <ul class="dropdown-menu" role="menu">
						<li><a href="formulir-keanggotaan.php">Formulir Keanggotaan</a></li>
