        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-18">
                    ...
                    <form action="<?php echo base_url(); ?>admin/about/update" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                        <?php $this->load->view("admin/about/_form"); ?>
