...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <?php $image = ($flag == "update") ? $image : "default-image.png"; ?>
        <img id="img_prev" style="border-radius:25px; box-shadow: 10px 10px 5px #888888; max-width:95%;border:6px groove #545565;" src="<?php echo base_url() . 'assets/img/' . $image;?>"  width="150" height="200"/>
    </div>
</div>
