...
<head>
    ...
    <?php echo Tb::modal(array(
        'id' => 'modal_confirm',
        'header' => 'Delete',
        'body' => '<strong>Apakah Anda yakin ingin menghapus article ini?</strong>',
        'footer' => array(
            Tb::button('Ya', array('onclick' => "deleted('article')", 'color' => Tb::BUTTON_COLOR_WARNING)),
    ...
    <?php echo Tb::modal(array(
        'id' => 'modal_approve',
        'header' => 'Approve',
        'body' => '<strong>Apakah Anda yakin ingin meng-approve article ini?</strong>',
        'footer' => array(
            Tb::button('Ya', array('onclick' => "approve('article')", 'color' => Tb::BUTTON_COLOR_WARNING)),
            TB::button('Tidak', array('data-dismiss' => 'modal'))
        )
    ));
    ?>
