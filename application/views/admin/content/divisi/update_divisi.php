    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- /.row -->
                <h2>Edit Division</h2><br>
                <div class="col-lg-20">
                    <?php echo $error_message; echo validation_errors(); ?><br>
                    <form action="<?php echo base_url() . 'admin/divisi/update/' . $divisi_id; ?>" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
