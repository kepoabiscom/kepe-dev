    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- /.row -->
                <h2>Edit Category Video</h2><br>
                <div class="col-lg-20">
                    <?php echo $error_message; echo validation_errors(); ?><br>
                    <form action="<?php echo base_url() . 'admin/category-video/update/' . $video_category_id; ?>" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
