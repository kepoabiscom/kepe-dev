$(document).ready(function () {
  ...
  function init() {
    var myLatlng = new google.maps.LatLng(-6.290491, 106.860785);
    var mapOptions = {
        zoom: 15,
        scrollwheel: false,
    ...
    var marker = new google.maps.Marker({
        position: myLatlng,
        icon:'http://beta.kepoabis.com/img/kepoabiscom.png',
        map: map,
        title: 'HAAMILL PRODUCTIONS TEAM ',
	animation:google.maps.Animation.BOUNCE
    });
	
	var infowindow = new google.maps.InfoWindow({
		content:"<h2>KEPOABIS.COM</h2><p>Jalan Pelita RT 02/09 No. 69 Kel. Tengah, Kec. Kramat Jati<br>Jakarta Timur - 13540, Indonesia </p>"
	 });
